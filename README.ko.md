...
`mkcv`는 PDF 생성에 `xelatex`를 사용합니다. 한국어 이력서를 제대로 렌더링하려면 XeLaTeX와 한글 폰트가 함께 설치되어 있어야 합니다.
...
MiKTeX 또는 TeX Live를 설치하고, `xelatex`가 동작하는지 확인하세요. 한국어 폰트 인식 문제가 있으면 Nanum 또는 Noto CJK 폰트를 운영체제에 설치하는 것이 좋습니다.
